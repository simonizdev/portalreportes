...
//EXCEL
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('B1', 'Tipo de documento');
  ...
  foreach ($data as $reg) {
    ...
    $objPHPExcel->setActiveSheetIndex()->setCellValue('B'.$Fila,$reg->idtipodocto->Descripcion);
  ...
  $n = 'Tipo_docto_usuario_'.date('Y-m-d H_i_s');
