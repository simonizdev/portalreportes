	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ITipoTercero[usuario_creacion]',
						'id'=>'ITipoTercero_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ITipoTercero[usuario_actualizacion]',
						'id'=>'ITipoTercero_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    	...
	    	<div class="form-group">
	          	<?php 
					$this->widget('application.extensions.PageSize.PageSize', array(
				        'mGridId' => 'ITipoTercero-grid', //Gridview id
...
<script type="text/javascript">
	...
	function resetfields(){
		...
		$('#ITipoTercero_usuario_creacion').val('').trigger('change');
		$('#ITipoTercero_Fecha_Creacion').val('');
		$('#ITipoTercero_usuario_actualizacion').val('').trigger('change');
