...
<div class="row mb-2">
  <div class="col-sm-9">
    <h4>Revisión solicitudes creación / actualización de productos</h4>
  </div>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
            'class'=>'CButtonColumn',
            'template'=>'{vc}{uc}{vu}{uu}',
            'buttons'=>array(
                'vc'=>array(
                    'label'=>'<i class="fa fa-eye actions text-dark"></i>',
                    'imageUrl'=>false,
                    'options'=>array('title'=>'Visualizar'),
                    'url'=>'Yii::app()->createUrl("fichaItem/view", array("id"=>$data->Id, "opc"=>2))',
                    'visible'=> '($data->Tipo == 1 && $data->Estado_Solicitud != 1)',
                ),
                'uc'=>array(
                    'label'=>'<i class="fa fa-pen actions text-dark"></i>',
                    'imageUrl'=>false,
                    'options'=>array('title'=>'Revisar'),
                    'url'=>'Yii::app()->createUrl("fichaItem/update", array("id"=>$data->Id))',
                    'visible'=> '($data->Tipo == 1 && $data->Estado_Solicitud == 1)',
                ),
                'vu'=>array(
                    'label'=>'<i class="fa fa-eye actions text-dark"></i>',
                    'imageUrl'=>false,
                    'options'=>array('title'=>'Visualizar'),
                    'url'=>'Yii::app()->createUrl("fichaItem/view2", array("id"=>$data->Id, "opc"=>2))',
                    'visible'=> '($data->Tipo == 2 && $data->Estado_Solicitud != 1)',
                ),
                'uu'=>array(
                    'label'=>'<i class="fa fa-pen actions text-dark"></i>',
                    'imageUrl'=>false,
                    'options'=>array('title'=>'Revisar'),
                    'url'=>'Yii::app()->createUrl("fichaItem/update2", array("id"=>$data->Id))',
                    'visible'=> '($data->Tipo == 2 && $data->Estado_Solicitud == 1)',
                ),
            )
        ),
