	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php echo $form->numberField($model,'Id_Rep', array('class' => 'form-control form-control-sm', 'autocomplete' => 'off', 'type' => 'number')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Rep[usuario_creacion]',
						'id'=>'Rep_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Rep[usuario_actualizacion]',
						'id'=>'Rep_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#Rep_Id_Rep').val('');
		$('#Rep_Descripcion').val('');
		$('#Rep_usuario_creacion').val('').trigger('change');
		$('#Rep_Fecha_Creacion').val('');
		$('#Rep_usuario_actualizacion').val('').trigger('change');
		$('#Rep_Fecha_Actualizacion').val('');
		$('#yt0').click();
	}
