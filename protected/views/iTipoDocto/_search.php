	...
	<div class="row">
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php echo $form->textField($model,'Tipo', array('class' => 'form-control', 'autocomplete' => 'off')); ?>
	        </div>
	    </div>
	   	<div class="col-sm-3">
	    	<div class="form-group">
	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ITipoDocto[usuario_creacion]',
						'id'=>'ITipoDocto_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ITipoDocto[usuario_actualizacion]',
						'id'=>'ITipoDocto_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		...
		$('#ITipoDocto_usuario_creacion').val('').trigger('change');
		$('#ITipoDocto_Fecha_Creacion').val('');
		$('#ITipoDocto_usuario_actualizacion').val('').trigger('change');
