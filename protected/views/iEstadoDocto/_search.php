	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'IEstadoDocto[usuario_creacion]',
						'id'=>'IEstadoDocto_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'IEstadoDocto[usuario_actualizacion]',
						'id'=>'IEstadoDocto_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		...
		$('#IEstadoDocto_usuario_creacion').val('').trigger('change');
		$('#IEstadoDocto_Fecha_Creacion').val('');
		$('#IEstadoDocto_usuario_actualizacion').val('').trigger('change');
