	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php echo $form->numberField($model,'Id_Departamento', array('class' => 'form-control', 'autocomplete' => 'off', 'type' => 'number')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Departamento[usuario_creacion]',
						'id'=>'Departamento_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Departamento[usuario_actualizacion]',
						'id'=>'Departamento_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    	...
	    	<div class="form-group">
	          	<?php 
					$this->widget('application.extensions.PageSize.PageSize', array(
				        'mGridId' => 'departamento-grid', //Gridview id
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#Departamento_Id_Departamento').val('');
		$('#Departamento_Codigo').val('');
		$('#Departamento_Descripcion').val('');
		$('#Departamento_usuario_creacion').val('').trigger('change');
		$('#Departamento_Fecha_Creacion').val('');
		$('#Departamento_usuario_actualizacion').val('').trigger('change');
		$('#Departamento_Fecha_Actualizacion').val('');
		$('#Departamento_Estado').val('').trigger('change');
		$('#Departamento_orderby').val('').trigger('change');
		$('#yt0').click();
	}
