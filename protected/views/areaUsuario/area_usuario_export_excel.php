...
//EXCEL
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('B1', 'Área');
  ...
  foreach ($data as $reg) {
    ...
    $objPHPExcel->setActiveSheetIndex()->setCellValue('B'.$Fila,UtilidadesVarias::descarea($reg->Id_Area));
  ...
  $n = 'Area_usuario_'.date('Y-m-d H_i_s');
