...
//EXCEL
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('B1', 'Bodega');
  ...
  foreach ($data as $reg) {
    ...
    $objPHPExcel->setActiveSheetIndex()->setCellValue('B'.$Fila,$reg->idbodega->Descripcion);
  ...
  $n = 'Bodega_usuario_'.date('Y-m-d H_i_s');
