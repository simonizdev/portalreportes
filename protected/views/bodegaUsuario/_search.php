	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
	          	<?php echo $form->label($model,'Id_B_Usuario'); ?>
			    <?php echo $form->numberField($model,'Id_B_Usuario', array('class' => 'form-control form-control-sm', 'autocomplete' => 'off', 'type' => 'number')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'BodegaUsuario[usuario]',
						'id'=>'BodegaUsuario_usuario',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'BodegaUsuario[bodega]',
						'id'=>'BodegaUsuario_bodega',
						'data'=>$lista_bodegas,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'BodegaUsuario[usuario_creacion]',
						'id'=>'BodegaUsuario_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'BodegaUsuario[usuario_actualizacion]',
						'id'=>'BodegaUsuario_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#BodegaUsuario_Id_B_Usuario').val('');
		$('#BodegaUsuario_usuario').val('').trigger('change');
		$('#BodegaUsuario_bodega').val('').trigger('change');
		$('#BodegaUsuario_usuario_creacion').val('').trigger('change');
		$('#BodegaUsuario_Fecha_Creacion').val('');
		$('#BodegaUsuario_usuario_actualizacion').val('').trigger('change');
