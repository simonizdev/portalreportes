	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ITercero[usuario_creacion]',
						'id'=>'ITercero_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ITercero[usuario_actualizacion]',
						'id'=>'ITercero_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	...
	<div class="row">
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php 
                	$array_orden = array(1 => 'ID ASC', 2 => 'ID DESC', 3 => 'Tipo ASC', 4 => 'Tipo DESC', 5 => 'Nit ASC', 6 => 'Nit DESC',7 => 'Nombres ASC', 8 => 'Nombres DESC', 9 => 'Usuario que creo ASC', 10 => 'Usuario que creo DESC', 11 => 'Fecha de creación ASC', 12 => 'Fecha de creación DESC', 13 => 'Usuario que actualizó ASC', 14 => 'Usuario que actualizó DESC', 15 => 'Fecha de actualización ASC', 16 => 'Fecha de actualización DESC', 17 => 'Estado ASC', 18 => 'Estado DESC',
					);
            	?>
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
...
<script type="text/javascript">
	...
	function resetfields(){
		...
		$('#ITercero_Nit').val('');
		$('#ITercero_Nombre').val('');
		$('#ITercero_usuario_creacion').val('').trigger('change');
		$('#ITercero_Fecha_Creacion').val('');
		$('#ITercero_usuario_actualizacion').val('').trigger('change');
