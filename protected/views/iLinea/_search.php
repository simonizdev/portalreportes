	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ILinea[usuario_creacion]',
						'id'=>'ILinea_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ILinea[usuario_actualizacion]',
						'id'=>'ILinea_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		...
		$('#ILinea_usuario_creacion').val('').trigger('change');
		$('#ILinea_Fecha_Creacion').val('');
		$('#ILinea_usuario_actualizacion').val('').trigger('change');
