                ...
                $this->widget('ext.select2.ESelect2', array(
                    ...
                    'options'  => array(
                        ...
                        'initSelection'=>'js:function(element,callback) {
				                   	...
				                   	if ( id !== "" ) {
				                     	$.ajax("'.Yii::app()->createUrl('itemUnidad/SearchUnidadById').'", {
				                       		data: { id: id },
				                       		dataType: "json"
...
$(function() {
  ...
  $('#ItemUnidad_UN_Venta').val(<?php echo $model->UN_Venta; ?>);
  $('#ItemUnidad_UN_Cadena').val(<?php echo $model->UN_Cadena; ?>);
  ...
  for (t = 1; t <= num_und ; t++) {
    ...
    var item = $('#ItemUnidad_Id_Item').val();
      ...
      $.ajax({ 
        ...
        success: function(data){
            if (data == 0) {
              ...
              $('#ItemUnidad_Id_Item_em_').html('Este item ya tiene unidades creadas en el sistema.');
              $('#ItemUnidad_Id_Item_em_').show();     
            } 
        }
      });

    }else{
    	$('#ItemUnidad_Id_Item_em_').html('Item no puede ser nulo.');
      $('#ItemUnidad_Id_Item_em_').show();
    }
	}
