...
<h3>Control de pedidos por segmento</h3>
...
<div class="row">
    <div class="col-sm-4">
      <div class="form-group">
        <?php echo $form->error($model,'segmento', array('class' => 'pull-right badge bg-red')); ?>
        <?php echo $form->label($model,'segmento'); ?>
        <?php
            $this->widget('ext.select2.ESelect2',array(
            'name'=>'Reporte[segmento]',
            'id'=>'Reporte_segmento',
...
function resetfields(){
  $('#Reporte_segmento').val('').trigger('change');
