...
$(function() {
  ...
  $("#download").click(function() {
    ...
    $("#mensaje").html('');
    window.location =  "<?php echo Yii::app()->getBaseUrl(true).'/images/guias/plantilla_flete_guia.xlsx'; ?>";
  });
  ...
  $("#valida_form").click(function() {
      ...
      if(valid_file == 1){
        ...
        $.ajax({
            url: "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=reporte/uploadfleteguia'; ?>",  
            type: 'POST',
            // Form data
