...
$query ="
SET NOCOUNT ON
EXEC [Qlik].[dbo].[PR_COM_RT_MARCA_FECH]
  @FECHA1 = N'".$FechaM1."',
  @FECHA2 = N'".$FechaM2."'
";
...
if($opcion == 1){
  ...
  class PDF extends FPDF{
    ...
    function Header(){
      ...
      $this->Cell(200,5,utf8_decode('Rentabilidad por marca (Perú)'),0,0,'L');
  ...
  $pdf->Tabla();
  ob_end_clean();
  $pdf->Output('D','Rentabilidad_marca_peru_'.date('Y-m-d H_i_s').'.pdf');
}
...
if($opcion == 2){
  ...
  $n = 'Rentabilidad_marca_peru_'.date('Y-m-d H_i_s');
