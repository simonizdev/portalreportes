...
$query ="
  EXEC  [dbo].[COM_RENT_FECH_MARCA_SINITEM]
    @FECHA1 = N'".$FechaM1."',
    @FECHA2 = N'".$FechaM2."'
";
...
if($opcion == 1){
  ...
  class PDF extends FPDF{
    ...
    function Header(){
      ...
      $this->Cell(160,5,'Rentabilidad por marca',0,0,'L');
      ...
      $this->Cell(29,2,utf8_decode('MARCA'),0,0,'L');
  ...
  $pdf->Tabla();
  ob_end_clean();
  $pdf->Output('D','Rentabilidad_marca_'.date('Y-m-d H_i_s').'.pdf');
}
...
if($opcion == 2){
  ...
  $n = 'Rentabilidad_marca_'.date('Y-m-d H_i_s');
