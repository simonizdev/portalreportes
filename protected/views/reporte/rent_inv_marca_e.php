...
<h4>Rentabilidad de inventario por marca (Ecuador)</h4>
    ...
    <div class="col-sm-4">
    	<div class="form-group">
      	...
      	<?php echo $form->label($model,'fecha_inicial'); ?>
		    <?php echo $form->textField($model,'fecha_inicial', array('class' => 'form-control orm-control-sm', 'readonly' => true)); ?>
        </div>
    </div>
    <div class="col-sm-4">
    	<div class="form-group">
      	...
      	<?php echo $form->label($model,'fecha_final'); ?>
		    <?php echo $form->textField($model,'fecha_final', array('class' => 'form-control orm-control-sm', 'readonly' => true)); ?>
        </div>
    </div>
  </div>
<div class="row">
