...
foreach ($array_info as $item => $data) {
    ...
    if($num_unds == 1){
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('U'.$Fila, $vc);
    ...
    if($num_unds == 2){
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('Y'.$Fila, $vg);
    ...
    if($num_unds == 3){
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('AC'.$Fila, $vk);
    ...
    if($num_unds == 4){
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('AG'.$Fila, $vo);
