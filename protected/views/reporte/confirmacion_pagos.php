...
$(function() {
  ...
  $("#valida_form").click(function() {
      ...
      if(valid_file == 1){
        ...
        $.ajax({
            url: "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=reporte/uploadconfirmacionpagos'; ?>",  
            type: 'POST',
            // Form data
  ...
  function validarExtension(datos) {
    ...
    if(extensionValida < 0) {
      ...
      $('#error_file').html('La extensión no es válida (.'+ extension+'), Solo se admite (.xls, xlsx)');
      $('#error_file').show();
      $('#valid_file').val(0);
      return false;
