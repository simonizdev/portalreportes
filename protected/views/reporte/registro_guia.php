...
$(function() {
  ...
  $("#download").click(function() {
    ...
    $("#mensaje").html('');
    window.location =  "<?php echo Yii::app()->getBaseUrl(true).'/images/guias/plantilla_guia.xlsx'; ?>";
  });
  ...
  $("#valida_form").click(function() {
      ...
      if(valid_file == 1){
        ...
        $.ajax({
            url: "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=reporte/uploadguia'; ?>",  
            type: 'POST',
            // Form data
