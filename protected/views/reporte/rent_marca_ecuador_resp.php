...
$query ="
SET NOCOUNT ON
EXEC [Portal_Reportes].[dbo].[EC_COM_RT_MARCA_FECH]
  @FECHA1 = N'".$FechaM1."',
  @FECHA2 = N'".$FechaM2."'
";
...
if($opcion == 1){
  ...
  class PDF extends FPDF{
    ...
    function Header(){
      ...
      $this->Cell(200,5,utf8_decode('Rentabilidad por marca (Ecuador)'),0,0,'L');
      ...
      $this->Cell(35,2,utf8_decode('MARCA'),0,0,'L');
      ...
      $this->Cell(16,2,utf8_decode('% UTILIDAD'),0,0,'R');
      $this->Cell(16,2,utf8_decode('COSTO'),0,0,'R');   
      $this->Ln(3);   
      ...
      $this->Cell(16,2,utf8_decode('INVENTARIO'),0,0,'R'); 
      $this->Ln(3);
    ...
    function Tabla(){
      ...
      foreach ($query1 as $reg1) {
        ...
        $this->Cell(35,3,substr(utf8_decode($MARCA),0 , 25),0,0,'L');
        ...
        $this->Cell(16,3,number_format(($COSTO_INV),2,".",","),0,0,'R');
        $this->Ln();
      ...
      $this->Cell(35,5,'TOTAL GENERAL',0,0,'R');
      ...
      $this->Cell(16,5,number_format(($COSTO_INV_st),2,".",","),0,0,'R');
      $this->Ln();
  ...
  $pdf->Tabla();
  ob_end_clean();
  $pdf->Output('D','Rentabilidad_marca_ecuador_'.date('Y-m-d H_i_s').'.pdf');
}
...
if($opcion == 2){
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('A1', 'MARCA');
  ...
  foreach ($query1 as $reg1) {
    ...
    $objPHPExcel->setActiveSheetIndex()->setCellValue('P'.$Fila, $COSTO_INV);
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('P'.$Fila, $COSTO_INV_st);
  ...
  $n = 'Rentabilidad_marca_ecuador_'.date('Y-m-d H_i_s');
