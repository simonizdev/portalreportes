...
$query= "
EXEC [dbo].[COM_REDES_RQM_FECH_LINEA]
...
if($opcion == 1){
  ...
  $pdf->Tabla();
  ob_end_clean();
  $pdf->Output('D','Ped_pend_des_rqm_linea_'.date('Y-m-d H_i_s').'.pdf');
}
...
if($opcion == 2){
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('A1', 'Criterio de búsqueda: Fecha del '.$fecha_inicial.' al '.$fecha_final.' / Línea de '.$linea_inicial.' a '.$linea_final);
  $objPHPExcel->getActiveSheet()->getStyle('A1')->getFont()->setBold(true);

  /*Cabecera tabla*/

  $objPHPExcel->setActiveSheetIndex()->setCellValue('A3', 'LÍNEA / ITEM');
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('E3', 'CANT. PEDIDA');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('F3', 'CANT. ENVIADA');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('G3', 'CANT. REDESP.');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('H3', 'CANT. PEND.');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('I3', 'CANT. PEND. RQM');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('J3', 'VALOR PEDIDO');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('K3', 'PEND. POR ENTRAR');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('L3', 'EN EXIST.');
  ...
  foreach ($query1 as $reg1) {
    ...
    if($linea != $linea_act){
      ...
      if($linea != ""){
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('D'.$Fila, 'TOTAL '.$linea);
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('I'.$Fila, $Cant_Pend_RQM_sp);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('J'.$Fila, $Vlr_Pedido_sp);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('K'.$Fila, $P_Entrar_sp);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('L'.$Fila, $Existencia_sp);

        $objPHPExcel->getActiveSheet()->getStyle('E'.$Fila.':I'.$Fila)->getNumberFormat()->setFormatCode('0');        
        ...
        $objPHPExcel->getActiveSheet()->getStyle('D'.$Fila.':L'.$Fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
        $objPHPExcel->getActiveSheet()->getStyle('D'.$Fila.':L'.$Fila)->getFont()->setBold(true);
      ...
      $objPHPExcel->setActiveSheetIndex()->setCellValue('A'.$Fila, $linea);
    ...
    $objPHPExcel->setActiveSheetIndex()->setCellValue('I'.$Fila, $Cant_Pend_RQM);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('J'.$Fila, $Vlr_Pedido);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('K'.$Fila, $P_Entrar);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('L'.$Fila, $Existencia);
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('I'.$Fila, $Cant_Pend_RQM_st);
  $objPHPExcel->setActiveSheetIndex()->setCellValue('J'.$Fila, $Vlr_Pedido_st);
  $objPHPExcel->setActiveSheetIndex()->setCellValue('K'.$Fila, $P_Entrar_st);
  $objPHPExcel->setActiveSheetIndex()->setCellValue('L'.$Fila, $Existencia_st);
  ...
  $n = 'Ped_pend_des_rqm_linea_'.date('Y-m-d H_i_s');
