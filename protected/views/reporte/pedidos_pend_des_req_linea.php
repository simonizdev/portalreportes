...
//para combos de líneas
$lista_lineas = CHtml::listData($lineas, 'DESCRIPCION', 'DESCRIPCION'); 

?>

<h3>Pedidos pendientes por despacho y requisiciones / línea</h3>
...
function resetfields(){
  ...
  $('#Reporte_linea_inicial').val('').trigger('change');
  $('#Reporte_linea_final').val('').trigger('change');
}
