...
class TipoDoctoUsuario extends CActiveRecord
{
	...
	{
		return 'TH_I_TIPO_DOCTO_USUARIO';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id_Td_Usuario, Id_Usuario, usuario_creacion, usuario_actualizacion, tipo_docto, Estado, Fecha_Creacion, Fecha_Actualizacion, orderby', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
	    ...
	    if($this->tipo_docto != ""){
			$criteria->AddCondition("idtipodocto.Descripcion = '".$this->tipo_docto."'"); 
	    }
	    ...
	    if(empty($this->orderby)){
			...
			switch ($this->orderby) {
			    case 1:
			        $criteria->order = 't.Id_Td_Usuario ASC'; 
			        break;
			    case 2:
			        $criteria->order = 't.Id_Td_Usuario DESC'; 
			        break;
