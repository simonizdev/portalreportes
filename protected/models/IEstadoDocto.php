...
/**
 * This is the model class for table "TH_I_ESTADO_DOCTO".
 *
 * The followings are the available columns in table 'TH_I_ESTADO_DOCTO':
 * @property integer $Id
...
class IEstadoDocto extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id, Descripcion, Estado, Fecha_Creacion, Fecha_Actualizacion, usuario_creacion, usuario_actualizacion, orderby', 'safe', 'on'=>'search'),
		);
	}
