...
/**
 * This is the model class for table "TH_I_BODEGA_USUARIO".
 *
 * The followings are the available columns in table 'TH_I_BODEGA_USUARIO':
...
class BodegaUsuario extends CActiveRecord
{
	...
	public function search()
	{
	    ...
	    if($this->bodega != ""){
			$criteria->AddCondition("idbodega.Descripcion = '".$this->bodega."'"); 
	    }
	    ...
	    if(empty($this->orderby)){
			...
			switch ($this->orderby) {
			    case 1:
			        $criteria->order = 't.Id_B_Usuario ASC'; 
			        break;
			    case 2:
			        $criteria->order = 't.Id_B_Usuario DESC'; 
			        break;
