...
/**
 * This is the model class for table "TH_I_TIPO_DOCTO".
 *
 * The followings are the available columns in table 'TH_I_TIPO_DOCTO':
 * @property integer $Id
...
class ITipoDocto extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id, Tipo, Descripcion, Estado, Fecha_Creacion, Fecha_Actualizacion, usuario_creacion, usuario_actualizacion, orderby', 'safe', 'on'=>'search'),
		);
	}
