...
class DepartamentoController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','searchdepartamento','searchdepartamentobyid'),
				'users'=>array('@'),
			),
	...
	public function actionSearchDepartamento(){
		$filtro = $_GET['q'];
        $data = Departamento::model()->searchByDepartamento($filtro);
        $result = array();
	...
	public function actionSearchDepartamentoById(){
		$filtro = $_GET['id'];
        $data = Departamento::model()->searchById($filtro);
