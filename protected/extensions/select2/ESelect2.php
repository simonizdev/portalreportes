...
class ESelect2 extends CInputWidget
{
    ...
    public function init()
    {
        $this->defaultOptions = array(
            'formatNoMatches' => 'js:function(){return "' . Yii::t('ESelect2.select2', 'No se encontraron resultados') . '";}',
            'formatInputTooShort' => 'js:function(input,min){return "' . Yii::t('ESelect2.select2', 'Digite más de {chars} caracteres para iniciar busquedaaaaaa', array('{chars}' => '"+(min-input.length)+"')) . '";}',
			'formatInputTooLong' => 'js:function(input,max){return "' . Yii::t('ESelect2.select2', 'Digite menos de {chars} caracteres para iniciar busqueda', array('{chars}' => '"+(input.length-max)+"')) . '";}',
            'formatSelectionTooBig' => 'js:function(limit){return "' . Yii::t('ESelect2.select2', 'Solo ha seleccionado {count} items', array('{count}' => '"+limit+"')) . '";}',
